...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onBackPressed() {
        ...
        if (frag instanceof BackPressedFragment) {
            ((BackPressedFragment) frag).onBackPressed();
            if (frag instanceof HomeFragment) super.onBackPressed();
        }
        else Log.e("MainActivity", "onBackPressed: Fragment was not backpressable");
    }
